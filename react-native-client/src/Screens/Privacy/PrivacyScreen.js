...
const htmlContent = `
<h2>Privacy Policy</h2> <p> Gunner Technology built the SimpliSurvey app as a Free app. This SERVICE is provided by
Gunner Technology at no cost and is intended for use as is.
...
accessible at SimpliSurvey unless otherwise defined in this Privacy Policy.
...
personally identifiable information, including but not limited to None. The information that we request will be retained by us and used as described in this privacy policy.
...
Privacy.navigationOptions = navigationProps => ({
  header: <Header
    leftComponent={{
      icon: `arrow-back`,
      onPress: () => navigationProps.navigation.popToTop()
    }}
    centerComponent={{
      text: "Privacy Policy"
    }}
